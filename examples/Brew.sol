...
contract BrewToken is StandardToken,owned {
    uint256 public startTime;
    uint256 public presale_lock_day;
    uint256 public team_total_lock_day;
    string public name = "BREW Token";
    ...
    function BrewToken(uint _totalSupply,uint256 _presale_lock_day,uint256 _team_total_lock_day,uint _team_lock_epoch) public{
        startTime = now;
