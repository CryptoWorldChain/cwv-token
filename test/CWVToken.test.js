...
const CWVTokenMock = artifacts.require('CWVTokenMock');

contract('CWVToken', function ([_, owner, recipient, anotherAccount]) {
  const ZERO_ADDRESS = '0x0000000000000000000000000000000000000000';

  beforeEach(async function () {
    this.token = await CWVTokenMock.new(owner, 100);
  });
